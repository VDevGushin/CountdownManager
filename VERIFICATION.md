...
Проверки запускаются через `swift run CoreChecks`: XCTest требует отсутствующий здесь полный Xcode, поэтому проверки используют независимый исполняемый target без внешних библиотек.
