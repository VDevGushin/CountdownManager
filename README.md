...
У события может быть от 0 до 5 коротких подзадач. Каждая содержит только текст до 50 символов и checkbox — без собственной даты, времени, приоритета, напоминания или вложенности. Подзадачи можно добавить сразу при создании события либо позже из карточки и редактора.
