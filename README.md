...
2. Укажите название, необязательную заметку до 280 символов, будущую дату, выберите один emoji из быстрых вариантов или через **«Ещё…»** и при желании добавьте подзадачи. Расширенный каталог состоит из пяти наборов — **«Общие»**, **«Дети»**, **«Работа»**, **«Транспорт»** и **«Праздники»**; между ними можно переключаться стрелками, точками или горизонтальным свайпом.
