...
2. Укажите название, необязательную заметку до 280 символов, будущую дату, один emoji через быстрые варианты или системный выбор macOS и при желании подзадачи.
...
Когда событий нет, панель показывает короткое пустое состояние с кнопкой **+ Добавить событие**, а строка меню сразу возвращается к **◷ Countdown**.
